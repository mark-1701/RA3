...
public class AgregarClienteNVenta extends javax.swing.JFrame {

    ClienteDAO dao = new ClienteDAO();

    public AgregarClienteNVenta() {
        initComponents();
        setResizable(false);
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        if (txtNombre.getText().isEmpty() || txtNIT.getText().isEmpty() || txtCorreo.getText().isEmpty()
            ...
            dao.add(cliente);
            this.dispose();
            JOptionPane.showMessageDialog(null, "Cliente Creado exitosamente", "Alerta", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarClienteNVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
